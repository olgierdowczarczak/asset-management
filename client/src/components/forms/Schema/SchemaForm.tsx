...
import type { ResourceSchema, FieldSchema } from '@/schemas/types';
import { extractId } from '@/schemas/utils';
    ...
    const renderField = (fieldName: string, fieldSchema: FieldSchema) => {
        ...
        switch (fieldSchema.type) {
            ...
            case 'polymorphicReference':
                ...
                const polyCollection = modelValue;
                const polyOptions = referenceOptions[polyCollection] || [];
